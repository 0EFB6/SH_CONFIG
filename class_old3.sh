periods=($(date -d 07:30 +%s) $(date -d 07:49 +%s) $(date -d 8:29 +%s) $(date -d 9:09 +%s) $(date -d 10:04 +%s) $(date -d 10:44 +%s) $(date -d 11:24 +%s) $(date -d 12:04 +%s) $(date -d 13:09 +%s) $(date -d 13:49 +%s) $(date -d 14:29 +%s))
...
chinese=( "${browser}https://meet.google.com/lookup/gjpo5sc755${ax};${autologin}" "Chinese" )

periods=($(date -d 07:28 +%s) $(date -d 07:48 +%s) $(date -d 8:26 +%s) $(date -d 9:06 +%s) $(date -d 10:01 +%s) $(date -d 10:41 +%s) $(date -d 11:21 +%s) $(date -d 12:01 +%s) $(date -d 13:06 +%s) $(date -d 13:46 +%s) $(date -d 14:27 +%s))
...
phy=( "${browser}https://meet.google.com/wdq-isxh-irv${ax}" "Phy" )
#phy=( "${browser}https://meet.google.com/lookup/er3addd22s${ax}" "Phy" ) 
newmath=( "${browser}https://meet.google.com/oxm-tdxx-yci${ax}" "New-Math" )
...
malayhis=( "${browser}https://meet.google.com/bhd-ciqy-hfr${ax}" "Malay-his" )
...
pe=( "${browser}https://meet.google.com/bhd-ciqy-hfr${ax}" "PE" )

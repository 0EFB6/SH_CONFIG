periods=($(date -d 07:28 +%s) $(date -d 07:49 +%s) $(date -d 8:28 +%s) $(date -d 9:08 +%s) $(date -d 10:03 +%s) $(date -d 10:43 +%s) $(date -d 11:23 +%s) $(date -d 12:03 +%s) $(date -d 13:08 +%s) $(date -d 13:48 +%s) $(date -d 14:28 +%s))
